...
class EstateLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def load(self):
        ...
        self.cricketSound = base.loadSfx('phase_4/audio/sfx/cricket_chirp.ogg')

        self.plane = EstatePlane.EstatePlane()
        ...
        base.cr.playGame.hood.loader.geom.find('**/tunnels1').setTwoSided(1)
