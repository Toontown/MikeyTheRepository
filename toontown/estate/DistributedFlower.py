...
class DistributedFlower(DistributedPlantBase.DistributedPlantBase, FlowerBase.FlowerBase):
    ...
    def loadModel(self):
        ...
        # load plot
        self._gplot = DistributedGardenPlot(self.cr)
        self._gplot.generate()
        self._gplot.doId = self.doId + 500
        self._gplot.setOwnerIndex(self.gardenBox.ownerIndex)
        self._gplot.setPlot(self.gardenBox.plot)
        self._gplot.announceGenerate()
        self._gplot.reparentTo(self)
        self._gplot.sendUpdate = self.gardenBox.hackedSendUpdate(self._gplot)
