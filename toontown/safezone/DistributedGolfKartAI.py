...
class DistributedGolfKartAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def acceptBoarder(self, avId, seatIndex):
        ...
        self.acceptOnce(self.air.getAvatarExitEvent(avId), self._DistributedGolfKartAI__handleUnexpectedExit, extraArgs = [
            avId])
    ...
    def clearFullNow(self, seatIndex):
        ...
        if avId == None:
            self.notify.warning('Seat index is none... ignoring')
        elif avId == 0:
