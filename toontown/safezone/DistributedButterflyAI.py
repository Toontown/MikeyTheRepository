...
class DistributedButterflyAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def enterFlying(self):
        ...
        taskMgr.doMethodLater(self.time, self._DistributedButterflyAI__handleArrival, self.uniqueName('butter-flying'))
    ...
    def enterLanded(self):
        ...
        taskMgr.doMethodLater(self.time, self._DistributedButterflyAI__ready, self.uniqueName('butter-ready'))
