    ...
    def __activateMinigame(self, task):
        ...
        if players:
            ...
            if len(players) > 1 and not noTravel and not aiNoTravel:
                mg = createMinigame(self.air, players, self.zoneId, newbieIds=newbieIds, metagameRound=0) #TODO: use holiday manager instead of this hardcoded shit
            else:
...
@magicWord(category=CATEGORY_FUN, types=[str], access=400)
