...
class DistributedBoatAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def enterDockedEast(self):
        taskMgr.doMethodLater(10.0, self._DistributedBoatAI__departEast, 'depart-east')
    ...
    def enterSailingWest(self):
        taskMgr.doMethodLater(20.0, self._DistributedBoatAI__dockWest, 'dock-west')
    ...
    def enterDockedWest(self):
        taskMgr.doMethodLater(10.0, self._DistributedBoatAI__departWest, 'depart-west')
    ...
    def enterSailingEast(self):
        taskMgr.doMethodLater(20.0, self._DistributedBoatAI__dockEast, 'dock-east')
