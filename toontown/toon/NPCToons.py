...
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK,
 ...
 # devs
 10001: (ToontownBattleGlobals.DROP_TRACK, 3, 220, 9),
 10002: (ToontownBattleGlobals.NPC_TOONS_HIT, ToontownBattleGlobals.UNIOR_FUCK_TOONS, 0, 10),
 10003: (ToontownBattleGlobals.SOUND_TRACK, 0, SpecialDamage(1, 250), 8),
 10004: (ToontownBattleGlobals.DROP_TRACK, 5, 1, 9),
 10006: (ToontownBattleGlobals.DROP_TRACK, 4, 75, 4),
 10007: (ToontownBattleGlobals.SOUND_TRACK, 0, 100, 5),
 10008: (ToontownBattleGlobals.SOUND_TRACK, 5, 250, 9),
 10009: (ToontownBattleGlobals.LURE_TRACK, 5, 0, 5),
 10010: (ToontownBattleGlobals.DROP_TRACK, 5, 90, 4),
 10011: (ToontownBattleGlobals.SOUND_TRACK, 4, SpecialDamageRange(1, 250), 7),
}

devSOS = [10001, 10002, 10003, 10004, 10005, 10006, 10007, 10008, 10009, 10010, 10011]
secretSOS = [10002, 10005]
...
FOnpcFriends = {9310: (ToontownBattleGlobals.LURE_TRACK,
 ...
 # devs
 10005: (ToontownBattleGlobals.NPC_RESTOCK_GAGS, -2, 0, 0),
}
