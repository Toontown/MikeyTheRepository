...
# FF quests
  ...
  7100: (FF_TIER + 1, Start,
         (VisitQuest,),
         Any, 10004,
         NA, 7101, DefaultDialog),
         
  7101: (FF_TIER + 1, Cont,
         (DeliverItemQuest, 13),
         Any, 9207,
         NA, (7202, 7203), DefaultDialog),
         
  7202: (FF_TIER + 1, Cont,
         (CogdoQuest, ToontownGlobals.FunnyFarm, 6),
         Any, 10004,
         NA, 7204, DefaultDialog),
         
  7203: (FF_TIER + 1, Cont,
         (BuildingQuest, ToontownGlobals.FunnyFarm, 10, Any, 3),
         Any, 10004,
         NA, 7204, DefaultDialog),
  ...
  7204: (FF_TIER + 1, Cont,
         ...
         Any, Same,
         NA, 7205, DefaultDialog),
         
  7205: (FF_TIER + 1, Cont,
         (DeliverItemQuest, 13),
         Any, 5208,
         NA, 7206, DefaultDialog),
         
  7206: (FF_TIER + 1, Cont,
         (FactoryQuest, Anywhere, 5),
         Any, Same,
         NA, (7207, 7208), DefaultDialog),
         
  7207: (FF_TIER + 1, Cont,
         (CFOQuest, 3),
         Any, Same,
         NA, 7209, DefaultDialog),
  ...
  7209: (FF_TIER + 1, Cont,
         (VisitQuest,),
         Any, 10004,
         NA, (7210, 7211), DefaultDialog),
         
  7210: (FF_TIER + 1, Cont,
         (CogQuest, Anywhere, 50, 'tbc', 'type'),
         Any, Same,
         NA, 7212, DefaultDialog),
...
if config.GetBool('protect-quest-bldgs', True):
