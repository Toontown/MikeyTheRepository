...
class DistributedSellbotBossAI(DistributedBossCogAI.DistributedBossCogAI, FSM.FSM):
    ...
    def generateSuits(self, battleNumber):
        ...
        if battleNumber == 1:
            easyCogs = self.invokeSuitPlanner(17, 0)
            hardCogs = self.invokeSuitPlanner(18, 0)
...
if config.GetBool('allow-boss-cheat', True): 
 @magicWord(category=CATEGORY_CHEAT, types=[])
 def setvpcheat():
