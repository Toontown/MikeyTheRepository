...
ReportPanelConfirmations = ('You are about to report that %s has used obscene, bigoted or sexually explicit language.',
 ...
 "You are about to report that %s has created a name that does not follow the Toontown House rules.",
...
FriendInviterPlayerFriendInfo = 'A friend across the Toontown House network'
...
PhotoPageTutorial = 'You haven\'t taken any photos yet! Press TAB to change your camera angle, and press F9 to take a snapshot.\n\n Once you\'ve made a snapshot, come here to manage and name them.'
...
QuestScriptTutorialBlocker_7 = "It's called the SpeedChat Plus button. You need to turn on Speedchat Plus in your Account Manager on the Toontown House Website to use it."
...
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'You never need to save your Toontown progress. The Toontown House servers continually save all the necessary information.',
 ...
 TIP_MINIGAME: ('Always remember: Crazy Clyde is the best at minigames!'),
...
CogdoFlyingGameElevatorRewardLaff = 'Great job, Toons!\nYou get a Toon-Up from the laff barrels you saved!'
